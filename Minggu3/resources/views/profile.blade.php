...
@section('container')
    <h1>Profil | Wishal Azharyan Al Hisyam</h1>
@endsection
...
<body>
    ...
    <section class="home">
        ...
        <div class="home-content">
            <img class="gambar" src="img/wishal (1).png" alt="">
            <h3>Hallo, Bro</h3>
            <h2>Nama Saya Wishal Azharyan Al Hisyam</h2>
            <h3>Dan Saya <span>Website Developer</span>
            </h3>
